...
contract DeployEcoCoin is Script {
    // Anvil private key for account 9; nothing dangerous to show.
    ...
    function run() external returns (EcoCoin, HelperConfig) {
        ...
        (
            ...
            string memory GenesisMunicipalityZipCode, // address RecyclerAddress, // address ShopAddress, // address MachineAddress, // address seondMunicipalityAddress,
            ,
            ,
            ,
            ,
