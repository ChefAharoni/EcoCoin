...
contract HelperConfig is Script {
    ...
    function getOrCreateAnvilEthConfig() public view returns (NetworkConfig memory) {
        ...
        return NetworkConfig({
            GenesisMunicipalityAddress: address(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266),
            GenesisMunicipalityZipCode: EUNICE_ZIP_CODE,
            RecyclerAddress: address(0x70997970C51812dc3A010C7d01b50e0d17dc79C8),
            ShopAddress: address(0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC),
            MachineAddress: address(0x90F79bf6EB2c4f870365E785982E1f101E93b906),
            secondMunicipalityAddress: address(0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65),
            secondMunicipalityZipCode: LAFAYETTE_ZIP_CODE
        });
    }
    ...
    function getGanacheNetConfig() public pure returns (NetworkConfig memory) {
        return NetworkConfig({
            GenesisMunicipalityAddress: address(0xc3b0360670CE81F91cE4529C22b9a0e97D96D171),
            GenesisMunicipalityZipCode: EUNICE_ZIP_CODE,
            RecyclerAddress: address(0xDf6B8E2Fc696A0A262D51E165b23d2f6F29AbEBD),
            ShopAddress: address(0x3F9210997349BdeC67e02837b9f6Bc7b2F4BFB97),
            MachineAddress: address(0x7f86b03950d1858FB80b5769B862d8fc9b031883),
            secondMunicipalityAddress: address(0xd984ba179fb11A8c3aa22552018a4086101cFE1D),
            secondMunicipalityZipCode: LAFAYETTE_ZIP_CODE
        });
    }
}
